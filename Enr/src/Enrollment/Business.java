...
// about this class
/*
This screen for Businessing users. We ask for grade and submit.
...
public class Business { 
	...
	public Business() { 
		...
		try { 
			...
			ResultSet myRe = mySt.executeQuery("select * from applicants_table where major = 'Business studies'");
